...
try:
    model = joblib.load  # Corrected: Use joblib.load to load the model
...
# Step 2: Health Metrics
    ...
    st.session_state["patient_details"]["bmi"] = st.number_input("BMI", min_value=0.0, value=bmi_value  # Use the explicitly converted float value)
